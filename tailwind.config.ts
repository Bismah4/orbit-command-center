  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        elevated: { DEFAULT: "hsl(var(--elevated))", foreground: "hsl(var(--elevated-foreground))" },
        sidebar: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 30px hsl(var(--primary) / 0.4), 0 0 80px hsl(var(--primary) / 0.15)" },
          "50%": { boxShadow: "0 0 60px hsl(var(--primary) / 0.7), 0 0 120px hsl(var(--primary) / 0.25)" },
        },
